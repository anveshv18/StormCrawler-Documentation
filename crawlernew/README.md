...
``` sh
storm jar target/crawlernew-1.0-SNAPSHOT.jar com.crawlernew.edu.CrawlTopology -conf crawler-conf.yaml -local
```
...
``` sh
storm jar target/crawlernew-1.0-SNAPSHOT.jar  org.apache.storm.flux.Flux --local crawler.flux --sleep 86400000
```
